...
# usage: python generate_ddl.py csv_file_to_be_converted
if len(sys.argv) != 2:
	print('Invalid number of parameters')
	print('Usage: python generate_ddl.py <path_to_csv_file>')
	print('Example: python generate_ddl.py discog_subset/releases.csv')
	sys.exit()
